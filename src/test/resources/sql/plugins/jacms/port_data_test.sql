...
<content id="ART187" typecode="ART" typedescr="Articolo rassegna stampa"><descr>una descrizione particolare</descr><groups mainGroup="free" /><categories /><attributes><attribute name="Titolo" attributetype="Text" /><list attributetype="Monolist" name="Autori" nestedtype="Monotext" /><attribute name="VediAnche" attributetype="Link" /><attribute name="CorpoTesto" attributetype="Hypertext" /><attribute name="Foto" attributetype="Image" /><attribute name="Data" attributetype="Date" /><attribute name="Numero" attributetype="Number" /></attributes><status>DRAFT</status></content>
', 'free', '1.0', 'admin', NULL, NULL, 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync, restriction) VALUES ('EVN20', 'EVN', 'Mostra zootecnica', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN20" typecode="EVN" typedescr="Evento"><descr>Mostra zootecnica</descr><groups mainGroup="free" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Mostra Zootecnica</text><text lang="en">Zootechnical exposure</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>Annuncio svolgimento mostra zootecnicaMostra</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20060214</date></attribute><attribute name="DataFine" attributetype="Date"><date>20060220</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', '20080209100217', '20080209123357', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN20" typecode="EVN" typedescr="Evento"><descr>Mostra zootecnica</descr><groups mainGroup="free" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Mostra Zootecnica</text><text lang="en">Zootechnical exposure</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>Annuncio svolgimento mostra zootecnicaMostra</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20060214</date></attribute><attribute name="DataFine" attributetype="Date"><date>20060220</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', 'free', '1.0', 'admin', NULL, NULL, 1, 'OPEN');
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync, restriction) VALUES ('EVN192', 'EVN', 'Evento 2', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
...
', 'free', '1.0', 'admin', NULL, NULL, 0, 'OPEN');
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('ART179', 'ART', 'una descrizione ON LINE', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
<content id="ART179" typecode="ART" typedescr="Articolo rassegna stampa"><descr>una descrizione ON LINE</descr><groups mainGroup="free" /><categories><category id="general_cat1" /><category id="general_cat2" /></categories><attributes><attribute name="Titolo" attributetype="Text" /><list attributetype="Monolist" name="Autori" nestedtype="Monotext" /><attribute name="VediAnche" attributetype="Link" /><attribute name="CorpoTesto" attributetype="Hypertext" /><attribute name="Foto" attributetype="Image" /><attribute name="Data" attributetype="Date"><date>20090716</date></attribute><attribute name="Numero" attributetype="Number" /></attributes><status>DRAFT</status></content>', '20051012105533', '20080210180714', NULL, 'free', '0.1', 'admin', NULL, NULL, 0);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('RAH1', 'RAH', 'Articolo', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
...
<content id="RAH1" typecode="RAH" typedescr="Tipo_Semplice"><descr>Articolo</descr><groups mainGroup="free" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Un bel titolo</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[test test]]></hypertext></attribute><attribute name="Foto" attributetype="Image" /><attribute name="email" attributetype="Monotext" /><attribute name="Numero" attributetype="Number" /><attribute name="Correlati" attributetype="Link" /><attribute name="Allegati" attributetype="Attach"><resource resourcetype="Attach" id="7" lang="it" /><text lang="it">lop</text><text lang="en">linux</text></attribute><attribute name="Checkbox" attributetype="CheckBox" /></attributes><status>DRAFT</status></content>
', 'free', '1.0', 'admin', NULL, NULL, 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('ART1', 'ART', 'Articolo', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
...
<content id="ART1" typecode="ART" typedescr="Articolo rassegna stampa"><descr>Articolo</descr><groups mainGroup="free" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Il titolo</text><text lang="en">The title</text></attribute><list attributetype="Monolist" name="Autori" nestedtype="Monotext"><attribute name="Autori" attributetype="Monotext"><monotext>Pippo</monotext></attribute><attribute name="Autori" attributetype="Monotext"><monotext>Paperino</monotext></attribute><attribute name="Autori" attributetype="Monotext"><monotext>Pluto</monotext></attribute></list><attribute name="VediAnche" attributetype="Link"><link type="external"><urldest>http://www.spiderman.org</urldest></link><text lang="it">Spiderman</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext" /><attribute name="Foto" attributetype="Image"><resource resourcetype="Image" id="44" lang="it" /><text lang="it">Image description</text></attribute><attribute name="Data" attributetype="Date"><date>20040310</date></attribute><attribute name="Numero" attributetype="Number" /></attributes><status>DRAFT</status></content>
', 'free', '1.0', 'admin', NULL, NULL, 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('EVN103', 'EVN', 'Contenuto 1 Coach', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN103" typecode="EVN" typedescr="Evento"><descr>Contenuto 1 Coach</descr><groups mainGroup="coach" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Titolo Contenuto 1 Coach</text><text lang="en">Coach''s content 1 - title</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[Corpo Testo Contenuto 1 Coach]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>19990415</date></attribute><attribute name="DataFine" attributetype="Date"><date>20000414</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', '20061221165150', '20061223125859', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN103" typecode="EVN" typedescr="Evento"><descr>Contenuto 1 Coach</descr><groups mainGroup="coach" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Titolo Contenuto 1 Coach</text><text lang="en">Coach''s content 1 - title</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[Corpo Testo Contenuto 1 Coach]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>19990415</date></attribute><attribute name="DataFine" attributetype="Date"><date>20000414</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', 'coach', '1.0', 'admin', NULL, NULL, 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('RAH101', 'RAH', 'Contenuto 1 Customers', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
...
<content id="RAH101" typecode="RAH" typedescr="Tipo_Semplice"><descr>Contenuto 1 Customers</descr><groups mainGroup="customers" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Titolo Contenuto 1 Customers</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[CorpoTesto Contenuto 1 Customers]]></hypertext></attribute><attribute name="Foto" attributetype="Image" /><attribute name="email" attributetype="Monotext" /><attribute name="Numero" attributetype="Number" /><attribute name="Correlati" attributetype="Link" /><attribute name="Allegati" attributetype="Attach" /><attribute name="Checkbox" attributetype="CheckBox" /></attributes><status>DRAFT</status></content>
', 'customers', '1.0', 'admin', NULL, NULL, 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('ART104', 'ART', 'Contenuto 2 Coach', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
...
<content id="ART104" typecode="ART" typedescr="Articolo rassegna stampa"><descr>Contenuto 2 Coach</descr><groups mainGroup="coach" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Titolo Contenuto 2 Coach</text></attribute><list attributetype="Monolist" name="Autori" nestedtype="Monotext"><attribute name="Autori" attributetype="Monotext"><monotext>Walter</monotext></attribute><attribute name="Autori" attributetype="Monotext"><monotext>Marco</monotext></attribute><attribute name="Autori" attributetype="Monotext"><monotext>Eugenio</monotext></attribute><attribute name="Autori" attributetype="Monotext"><monotext>William</monotext></attribute></list><attribute name="VediAnche" attributetype="Link"><link type="external"><urldest>http://www.japsportal.org</urldest></link><text lang="it">Home jAPS</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[Corpo Testo Contenuto&nbsp;2 Coach]]></hypertext></attribute><attribute name="Foto" attributetype="Image" /><attribute name="Data" attributetype="Date"><date>20070104</date></attribute><attribute name="Numero" attributetype="Number" /></attributes><status>DRAFT</status></content>
', 'coach', '1.0', 'admin', NULL, NULL, 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('EVN23', 'EVN', 'Collezione Ingrao', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN23" typecode="EVN" typedescr="Evento"><descr>Collezione Ingrao</descr><groups mainGroup="free" /><categories><category id="general_cat1" /></categories><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Collezione Ingri</text><text lang="en">Ingri Collection</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[Nei rinnovati spazi della Galleria Comunale d''Arte sono ospitate le opere pittoriche e scultoree, quelle che dell''intero lascito di Giovanni Ingri rientrano nel periodo moderno e contemporaneo.]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20080213</date></attribute><attribute name="DataFine" attributetype="Date"><date>20080222</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', '20080209100541', '20080209100546', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN23" typecode="EVN" typedescr="Evento"><descr>Collezione Ingrao</descr><groups mainGroup="free" /><categories><category id="general_cat1" /></categories><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Collezione Ingri</text><text lang="en">Ingri Collection</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[Nei rinnovati spazi della Galleria Comunale d''Arte sono ospitate le opere pittoriche e scultoree, quelle che dell''intero lascito di Giovanni Ingri rientrano nel periodo moderno e contemporaneo.]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20080213</date></attribute><attribute name="DataFine" attributetype="Date"><date>20080222</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', 'free', '1.0', 'admin', NULL, NULL, 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('EVN24', 'EVN', 'Castello dei bambini', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN24" typecode="EVN" typedescr="Evento"><descr>Castello dei bambini</descr><groups mainGroup="free" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Castello dei bambini</text><text lang="en">Children''s castle</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>Descrizion evento Castello dei bambini</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20090318</date></attribute><attribute name="DataFine" attributetype="Date"><date>20090326</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', '20080209100714', '20080209100719', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN24" typecode="EVN" typedescr="Evento"><descr>Castello dei bambini</descr><groups mainGroup="free" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Castello dei bambini</text><text lang="en">Children''s castle</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>Descrizion evento Castello dei bambini</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20090318</date></attribute><attribute name="DataFine" attributetype="Date"><date>20090326</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', 'free', '1.0', 'admin', NULL, NULL, 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('EVN41', 'EVN', 'Mostra della ciliegia', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN41" typecode="EVN" typedescr="Evento"><descr>Mostra della ciliegia</descr><groups mainGroup="coach" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Sagra della ciliegia</text><text lang="en">Cherry festival</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>Sagra della ciliegia</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20080106</date></attribute><attribute name="DataFine" attributetype="Date"><date>20080124</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', '20080209102901', '20080209102903', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN41" typecode="EVN" typedescr="Evento"><descr>Mostra della ciliegia</descr><groups mainGroup="coach" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Sagra della ciliegia</text><text lang="en">Cherry festival</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>Sagra della ciliegia</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20080106</date></attribute><attribute name="DataFine" attributetype="Date"><date>20080124</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', 'coach', '1.0', 'admin', NULL, NULL, 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('EVN21', 'EVN', 'Sagra delle fragole', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN21" typecode="EVN" typedescr="Evento"><descr>Sagra delle fragole</descr><groups mainGroup="free" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Mostra Delle Fragole</text><text lang="en">Strawberries Festival</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>Mostre delle fragole</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20060113</date></attribute><attribute name="DataFine" attributetype="Date"><date>20060304</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', '20080209123547', '20080209123637', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN21" typecode="EVN" typedescr="Evento"><descr>Sagra delle fragole</descr><groups mainGroup="free" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Mostra Delle Fragole</text><text lang="en">Strawberries Festival</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>Mostre delle fragole</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20060113</date></attribute><attribute name="DataFine" attributetype="Date"><date>20060304</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', 'free', '1.0', 'admin', NULL, NULL, 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync, restriction) VALUES ('EVN25', 'EVN', 'TEATRO DELLE MERAVIGLIE', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN25" typecode="EVN" typedescr="Evento"><descr>TEATRO DELLE MERAVIGLIE</descr><groups mainGroup="coach"><group name="free" /><group name="group1" /><group name="group2" /><group name="group3" /></groups><categories><category id="general_cat1" /><category id="general_cat2" /></categories><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">TEATRO DELLE MERAVIGLIE</text><text lang="en">Wonder''s theater</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>TEATRO DELLE MERAVIGLIE  Laboratori Creativi</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20071212</date></attribute><attribute name="DataFine" attributetype="Date"><date>20071222</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', '20080209100902', '20080209100915', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN25" typecode="EVN" typedescr="Evento"><descr>TEATRO DELLE MERAVIGLIE</descr><groups mainGroup="coach"><group name="free" /><group name="group1" /><group name="group2" /><group name="group3" /></groups><categories><category id="general_cat1" /><category id="general_cat2" /></categories><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">TEATRO DELLE MERAVIGLIE</text><text lang="en">Wonder''s theater</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>TEATRO DELLE MERAVIGLIE  Laboratori Creativi</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20071212</date></attribute><attribute name="DataFine" attributetype="Date"><date>20071222</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', 'coach', '1.0', 'admin', 'editor2', NULL, 1, 'RESTRICTED');
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('EVN191', 'EVN', 'Evento 1', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN191" typecode="EVN" typedescr="Evento"><descr>Evento 1</descr><groups mainGroup="free" /><group name="group1" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Titolo A - Evento 1</text><text lang="en">Title C - Event 1</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>CorpoTesto Evento 1</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>19960417</date></attribute><attribute name="DataFine" attributetype="Date"><date>19960617</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', '20060418142200', '20061221161157', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN191" typecode="EVN" typedescr="Evento"><descr>Evento 1</descr><groups mainGroup="free" /><group name="group1" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Titolo A - Evento 1</text><text lang="en">Title C - Event 1</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>CorpoTesto Evento 1</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>19960417</date></attribute><attribute name="DataFine" attributetype="Date"><date>19960617</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link" /></attributes><status>DRAFT</status></content>
', 'free', '1.0', 'admin', 'editor1', NULL, 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('EVN194', 'EVN', 'Evento 4', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
...
<content id="EVN194" typecode="EVN" typedescr="Evento"><descr>Evento 4</descr><groups mainGroup="free" /><categories /><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Titolo D - Evento 4</text><text lang="en">Title A - Event 4</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>CorpoTesto&nbsp;Evento 4</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20220219</date></attribute><attribute name="DataFine" attributetype="Date"><date>20220419</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link"><attribute name="LinkCorrelati" attributetype="Link"><link type="content"><contentdest>ART1</contentdest></link><text lang="it">Link 1</text></attribute><attribute name="LinkCorrelati" attributetype="Link"><link type="page"><pagedest>pagina_11</pagedest></link><text lang="it">Link 2</text></attribute></list></attributes><status>DRAFT</status></content>
', 'free', '1.0', 'admin', 'editor1', NULL, 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('ART112', 'ART', 'Contenuto 4 Coach', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
...
', 'coach', '2.2', 'admin', NULL, '20120803222829', 0);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('ART180', 'ART', 'una descrizione', 'READY', '<?xml version="1.0" encoding="UTF-8"?>
...
', 'free', '1.0', 'admin', NULL, NULL, 0);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('ART102', 'ART', 'Contenuto 2 Customers', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
...
<content id="ART102" typecode="ART" typedescr="Articolo rassegna stampa"><descr>Contenuto 2 Customers</descr><groups mainGroup="customers" /><categories><category id="general_cat1" /></categories><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Titolo Contenuto 2 Customers</text></attribute><list attributetype="Monolist" name="Autori" nestedtype="Monotext" /><attribute name="VediAnche" attributetype="Link"><link type="content"><contentdest>ART111</contentdest></link><text lang="it">Contenuto autorizzato Gruppo Coath</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>Corpo Testo Contenuto&nbsp;2 Customers</p>]]></hypertext></attribute><attribute name="Foto" attributetype="Image" /><attribute name="Data" attributetype="Date" /><attribute name="Numero" attributetype="Number" /></attributes><status>DRAFT</status></content>
', 'customers', '1.0', 'admin', NULL, NULL, 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('EVN193', 'EVN', 'Evento 3', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN193" typecode="EVN" typedescr="Evento"><descr>Evento 3</descr><groups mainGroup="free" /><group name="group1" /><group name="group2" /><categories><category id="evento" /><category id="general_cat2" /></categories><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Titolo C - Evento 3</text><text lang="en">Title D - Evento 3</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>CorpoTesto Evento 3</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20170412</date></attribute><attribute name="DataFine" attributetype="Date"><date>20170912</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link"><attribute name="LinkCorrelati" attributetype="Link"><link type="content"><contentdest>ART1</contentdest></link><text lang="it">Link 1</text></attribute><attribute name="LinkCorrelati" attributetype="Link"><link type="page"><pagedest>pagina_11</pagedest></link><text lang="it">Link 2</text></attribute></list></attributes><status>DRAFT</status></content>
', '20060418142409', '20061221161125', '<?xml version="1.0" encoding="UTF-8"?>
<content id="EVN193" typecode="EVN" typedescr="Evento"><descr>Evento 3</descr><groups mainGroup="free" /><group name="group1" /><group name="group2" /><categories><category id="evento" /></categories><attributes><attribute name="Titolo" attributetype="Text"><text lang="it">Titolo C - Evento 3</text><text lang="en">Title D - Evento 3</text></attribute><attribute name="CorpoTesto" attributetype="Hypertext"><hypertext lang="it"><![CDATA[<p>CorpoTesto Evento 3</p>]]></hypertext></attribute><attribute name="DataInizio" attributetype="Date"><date>20170412</date></attribute><attribute name="DataFine" attributetype="Date"><date>20170912</date></attribute><attribute name="Foto" attributetype="Image" /><list attributetype="Monolist" name="LinkCorrelati" nestedtype="Link"><attribute name="LinkCorrelati" attributetype="Link"><link type="content"><contentdest>ART1</contentdest></link><text lang="it">Link 1</text></attribute><attribute name="LinkCorrelati" attributetype="Link"><link type="page"><pagedest>pagina_11</pagedest></link><text lang="it">Link 2</text></attribute></list></attributes><status>DRAFT</status></content>
', 'free', '1.0', 'admin', NULL, NULL, 0);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('ART111', 'ART', 'Contenuto 3 Coach', 'PUBLIC', '<?xml version="1.0" encoding="UTF-8"?>
...
', 'coach', '4.0', 'admin', NULL, '20120803222621', 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('ART120', 'ART', 'Contenuto degli amministratori 1', 'PUBLIC', '<?xml version="1.0" encoding="UTF-8"?>
...
', 'administrators', '1.0', 'admin', NULL, '20120803222703', 1);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('ART121', 'ART', 'Contenuto degli amministratori 2', 'DRAFT', '<?xml version="1.0" encoding="UTF-8"?>
...
', 'administrators', '2.1', 'admin', NULL, '20120803222859', 0);
INSERT INTO contents (contentid, contenttype, descr, status, workxml, created, lastmodified, onlinexml, maingroup, currentversion, lasteditor, firsteditor, published, sync) VALUES ('ART122', 'ART', 'Contenuto degli amministratori 3', 'PUBLIC', '<?xml version="1.0" encoding="UTF-8"?>
...
', 'free', '6.0', 'admin', NULL, '20150321171007', 0);




INSERT INTO resources (resid, restype, descr, maingroup, resourcexml, masterfilename, creationdate, lastmodified, owner) VALUES ('6', 'Attach', 'Text resource', 'free', '<?xml version="1.0" encoding="UTF-8"?>
...
', 'text_resource.txt', '2008-09-25 00:00:00', '2013-09-10 00:00:00', 'admin');
INSERT INTO resources (resid, restype, descr, maingroup, resourcexml, masterfilename, creationdate, lastmodified, owner) VALUES ('7', 'Attach', 'configurazione', 'free', '<?xml version="1.0" encoding="UTF-8"?>
...
', 'configurazione.txt', '2010-08-25 10:12:00', '2012-07-25 00:10:00', 'admin');
INSERT INTO resources (resid, restype, descr, maingroup, resourcexml, masterfilename, creationdate, lastmodified, owner) VALUES ('8', 'Attach', 'Text resource', 'customers', '<?xml version="1.0" encoding="UTF-8"?>
...
', 'text_resource.txt', '2008-09-25 00:00:00', '2013-09-10 00:00:00', 'admin');
INSERT INTO resources (resid, restype, descr, maingroup, resourcexml, masterfilename, creationdate, lastmodified, owner) VALUES ('82', 'Image', 'Entando', 'customers', '<?xml version="1.0" encoding="UTF-8"?>
...
INSERT INTO widgetcatalog (code, titles, parameters, plugincode, parenttypecode, defaultconfig, locked, maingroup, readonlydefaultconfig) VALUES ('90_events', '<?xml version="1.0" encoding="UTF-8"?>
<properties>
...
INSERT INTO contentrelations (contentid, refpage, refcontent, refresource, refcategory, refgroup) VALUES ('EVN25', NULL, NULL, NULL, NULL, 'group1');
INSERT INTO contentrelations (contentid, refpage, refcontent, refresource, refcategory, refgroup) VALUES ('EVN25', NULL, NULL, NULL, NULL, 'group2');
INSERT INTO contentrelations (contentid, refpage, refcontent, refresource, refcategory, refgroup) VALUES ('EVN25', NULL, NULL, NULL, NULL, 'group3');
INSERT INTO contentrelations (contentid, refpage, refcontent, refresource, refcategory, refgroup) VALUES ('EVN25', NULL, NULL, NULL, 'general', NULL);
INSERT INTO contentrelations (contentid, refpage, refcontent, refresource, refcategory, refgroup) VALUES ('EVN25', NULL, NULL, NULL, 'general_cat1', NULL);
INSERT INTO contentrelations (contentid, refpage, refcontent, refresource, refcategory, refgroup) VALUES ('EVN25', NULL, NULL, NULL, 'general_cat2', NULL);
...
INSERT INTO contentrelations (contentid, refpage, refcontent, refresource, refcategory, refgroup) VALUES ('EVN191', NULL, NULL, NULL, NULL, 'group1');
...
INSERT INTO contentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN25', 'Titolo', 'Wonder''s theater', NULL, NULL, 'en');
...
INSERT INTO contentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN41', 'Titolo', 'Cherry festival', NULL, NULL, 'en');
...
INSERT INTO contentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN103', 'Titolo', 'Coach''s content 1 - title', NULL, NULL, 'en');
...
INSERT INTO contentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN21', 'Titolo', 'Strawberries Festival', NULL, NULL, 'en');
...
INSERT INTO contentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN24', 'Titolo', 'Children''s castle', NULL, NULL, 'en');
...
INSERT INTO contentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN23', 'Titolo', 'Ingri Collection', NULL, NULL, 'en');
...
INSERT INTO contentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN20', 'Titolo', 'Zootechnical exposure', NULL, NULL, 'en');
INSERT INTO contentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN20', 'DataInizio', NULL, '2006-02-14 00:00:00', NULL, NULL);
...
INSERT INTO workcontentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN25', 'Titolo', 'Wonder''s theater', NULL, NULL, 'en');
...
INSERT INTO workcontentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN41', 'Titolo', 'Cherry festival', NULL, NULL, 'en');
...
INSERT INTO workcontentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN103', 'Titolo', 'Coach''s content 1 - title', NULL, NULL, 'en');
...
INSERT INTO workcontentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN21', 'Titolo', 'Strawberries Festival', NULL, NULL, 'en');
...
INSERT INTO workcontentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN24', 'Titolo', 'Children''s castle', NULL, NULL, 'en');
...
INSERT INTO workcontentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN23', 'Titolo', 'Ingri Collection', NULL, NULL, 'en');
...
INSERT INTO workcontentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN20', 'Titolo', 'Zootechnical exposure', NULL, NULL, 'en');
INSERT INTO workcontentsearch (contentid, attrname, textvalue, datevalue, numvalue, langcode) VALUES ('EVN20', 'DataInizio', NULL, '2006-02-14 00:00:00', NULL, NULL);
